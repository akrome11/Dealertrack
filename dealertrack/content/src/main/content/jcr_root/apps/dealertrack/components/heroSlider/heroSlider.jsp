...
<slice:lookup appName="dealertrack" var="model" type="<%=dealertrack.cms.aem.web.models.HeroSliderModel.class%>" />
    <c:forEach var="i" begin="1" end="${model.number}">
        <c:set var="path" value="resourceComponent${i}"/>
        <cq:include path="${path}" resourceType = "dealertrack/components/heroSliderItem" />
	</c:forEach>
